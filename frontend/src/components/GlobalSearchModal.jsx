        ...
        <div className="search-results" style={{ maxHeight: '400px', overflowY: 'auto', marginTop: '20px' }}>
          ...
          {results.map((res, idx) => (
            ...
            >
              ...
              <div style={{ fontSize: '14px', marginTop: '4px' }}>{sanitizeHtml(res.front_content || '', { allowedTags: sanitizeHtml.defaults.allowedTags, allowedAttributes: {} }).substring(0, 100)}...</div>
            </div>
          ))}
        </div>
      </div>
